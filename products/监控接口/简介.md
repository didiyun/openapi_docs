...
|dc2 |host.disk.bytes.used |磁盘使用量 |bytes |针对单个磁盘指标|
|dc2 |host.disk.used.percent |磁盘使用率 |% | 针对单个磁盘指标|
|dc2 |host.disk.inodes.used |磁盘inode使用量 |个 | 针对单个磁盘指标|
|dc2 |host.disk.inodes.used.percent |磁盘inode使用率 |% | 针对单个磁盘指标|
